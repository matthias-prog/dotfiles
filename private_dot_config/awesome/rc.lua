...
beautiful.init("/home/matze/.config/awesome/theme.lua")
...
vicious.register(pkg_widget, vicious.widgets.pkg,
    function (widget, args)
        if args[1] == 0 then
            ...
            return ('Updates: %s'):format(args[1])
        end  
    end
    , 60,  "Arch C")
...
--    set_wallpaper(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            weather_widget({
                api_key = '22cbe6730040b7e01b05011798c9e949',
                coordinates = {48.6383, 9.1326},
            }),
            mytextclock,
            logout_menu_widget(),
            s.mylayoutbox,
...
-- awful.spawn.with_shell("feh --randomize --bg-fill --no-fehbg ~/Pictures/wallpapers-dt/*")
